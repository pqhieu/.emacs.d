...
(let ((fg "#111111")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive ((t (:background ,bg-light :foreground ,fg :height 1.0))))
   ...
   ;; org
   `(org-agenda-date ((t (:foreground ,fg :height 1.0))))
   `(org-agenda-date-today ((t (:foreground ,fg :weight bold :height 1.0))))
   ...
   `(org-block-begin-line ((t (:foreground ,fg-light :height 1.0))))
   `(org-block-end-line ((t (:foreground ,fg-light :height 1.0))))
   ...
   `(org-level-1 ((t (:foreground ,fg :weight semi-bold :height 1.0))))
   `(org-level-2 ((t (:foreground ,fg :weight semi-bold :height 1.0 :overline ,bg))))
   `(org-level-3 ((t (:foreground ,fg :weight semi-bold :height 1.0 :overline ,bg))))
   `(org-level-4 ((t (:foreground ,fg :weight semi-bold :height 1.0 :overline ,bg))))
   `(org-level-5 ((t (:foreground ,fg :weight semi-bold :height 1.0 :overline ,bg))))
   `(org-level-6 ((t (:foreground ,fg :weight semi-bold :height 1.0 :overline ,bg))))
   ...
   `(magit-section-heading ((t (:weight semi-bold :height 1.0))))
